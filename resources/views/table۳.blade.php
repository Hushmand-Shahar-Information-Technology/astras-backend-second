...
@section('content')
    <div class="container mt-4">
        <h3 class="text-center mb-4">فورم ثبت واګون های  خشکه باب صادراتی آمریت استیشن خط آهن</h3>
        <table class="table table-bordered table-striped table-sm table-smaller">
            <thead>
                <tr>
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="نمبر پردادکه: activate to sort column ascending">نمبر واګږن</th>
